      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 min-[690px]:grid-cols-4 lg:grid-cols-6 gap-4 xl:gap-8 pt-14 pb-10 max-w-xs mx-auto min-[690px]:max-w-2xl lg:max-w-full">
          ...
          <div className="lg:mx-auto text-left ">
            <h4 className="text-[24px] text-gray-900 font-medium mb-7">
              Links úteis
            </h4>
            <ul className="text-xl transition-all duration-500">
              <li className="mb-6">
                <a
                  href="#"
                  className="text-gray-600 whitespace-nowrap hover:text-colorPrimary"
                >
                  Sobre nós
                </a>
              </li>
          ...
          <div className="lg:mx-auto text-left ">
            ...
            <ul className="text-xl  transition-all duration-500">
              <li className="mb-6">
                <a
                  href="#"
                  className="text-[#555555] hover:text-colorPrimary"
                >
                  Home
                </a>
              </li>
              ...
              <li className="mb-6">
                <a
                  href="#"
                  className=" text-gray-600 hover:text-colorPrimary"
                >
                  Menus
                </a>
              </li>
          ...
          <div className="lg:mx-auto text-left ">
            ...
            <ul className="text-xl  transition-all duration-500">
              <li className="mb-6">
                <a
                  href="#"
                  className="text-[#555555] font-medium whitespace-nowrap hover:text-colorPrimary"
                >
                  example@email.com
                </a>
              </li>
        ...
        <div className="py-7 border-t border-gray-200">
          <div className="flex items-center flex-col lg:gap-44 lg:flex-row">
            <div className="flex mb-4 lg:mb-0 space-x-4 sm:justify-center lg:mt-0 ">
              <a
                href="#"
              ...
              <a
                href="#"
                className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#1DA1F2] hover:bg-gray-900"
              >
                <svg
                  ...
                  fill="currentColor"
                >
                  <path d="M23.643 4.937a9.847 9.847 0 01-2.828.775 4.932 4.932 0 002.163-2.724 9.865 9.865 0 01-3.127 1.195 4.918 4.918 0 00-8.384 4.482A13.945 13.945 0 011.671 3.149a4.913 4.913 0 001.523 6.573 4.902 4.902 0 01-2.229-.616v.062a4.917 4.917 0 003.946 4.827 4.934 4.934 0 01-2.224.084 4.919 4.919 0 004.598 3.417A9.869 9.869 0 010 19.539a13.905 13.905 0 007.548 2.212c9.055 0 14.002-7.502 14.002-14.002 0-.213-.005-.426-.014-.637A10.012 10.012 0 0024 4.59a9.857 9.857 0 01-2.357.647z" />
                </svg>
              </a>
