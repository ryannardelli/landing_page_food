export const CardAbout = () => {
  return (
    <section
      id="features"
      className="px-2 space-y-6 py-8 md:py-12 lg:py-12 max-w-5x1 mx-auto"
    >
      <div className="mx-auto grid justify-center gap-12 md:gap-12 max-md:gap-x-12 lg:gap-x-44 xl:gap-12 2x1:gap-12 sm:grid-cols-2 md:max-w-[64rem]md:grid-cols-2">
