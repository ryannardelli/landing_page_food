  ...
  return (
    <nav className="bg-white">
      <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
        ...
        >
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white text-[25px] tracking- font-extrabold">
            <span className="bg-colorPrimary text-white p-1 rounded">F</span>ood
          </span>
        </a>
        <button
