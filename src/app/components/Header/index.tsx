  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
        ...
        >
          <ul className="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse text-xl">
            <li>
              <a
                href="#"
                className="block py-2 px-3 text-colorPrimary border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-colorPrimary md:p-0 dark:text-colorPrimary-50 md:dark:hover:text-colorPrimary dark:hover:bg-gray-700 dark:hover:text-colorPrimary md:dark:hover:bg-transparent dark:border-gray-700"
                aria-current="page"
              >
                Home
              </a>
            ...
            <li>
              <button
                ...
                className="flex items-center justify-between w-full py-2 px-3 font-medium text-gray-900 border-b border-gray-100 md:w-auto hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-colorPrimary md:p-0 dark:text-white md:dark:hover:text-assetsdark:hover:bg-gray-700 dark:hover:text-colorPrimary md:dark:hover:bg-transparent dark:border-gray-700"
              >
                Menu
                <svg
            ...
            <li>
              <a
                href="#"
                className="block py-2 px-3 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-colorPrimary md:p-0 dark:text-white md:dark:hover:text-colorPrimary dark:hover:bg-gray-700 dark:hover:text-colorPrimarymd:dark:hover:bg-transparent dark:border-gray-700"
              >
                Ofertas
              </a>
            </li>
